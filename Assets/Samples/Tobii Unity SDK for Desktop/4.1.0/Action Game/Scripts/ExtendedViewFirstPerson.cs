...
namespace Tobii.Gaming.Examples.ActionGame
{
	...
	{
		[Tooltip(
			"Optional reference to a crosshair Image. If supplied the crosshair will be moved according to the character forward direction rather than stay at the center of screen.")]
